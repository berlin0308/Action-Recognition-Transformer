...
def parse_opts():
    ...
    parser.add_argument('--root_path',
                        default='~/kenshohara/3D-ResNets-PyTorch/',
                        type=Path,
                        help='Root directory path')
    parser.add_argument('--video_path',
                        default='green_data/jpgs/',
                        type=Path,
                        help='Directory path of videos')
    parser.add_argument('--annotation_path',
                        default='green_data/g_json/greenhouse.json',
                        type=Path,
                        help='Annotation file path')
    parser.add_argument('--result_path',
                        default='green_data/results_inf_1',
                        type=Path,
    ...
    parser.add_argument('--sample_size',
                        default=224,
                        type=int,
                        help='Height and width of inputs (randomly crop size x size from the training data)')
    parser.add_argument('--sample_duration',
                        default=32,
                        type=int,
                        help='Temporal duration of inputs (randomly crop X frames from the training data)')
    parser.add_argument(
        '--sample_t_stride',
        default=0,
        type=int,
    ...
    parser.add_argument('--ipcam',
                        action='store_true',
                        help='If true, real time ipcam is performed.')
    ...
    parser.add_argument('--inf_day',
                        action='store_true',
                        help='If true, day inferencing is performed.')
    parser.add_argument('--inf_test_data',
                        action='store_true',
                        help='If true, test data inference is performed.')
    parser.add_argument('--inf_day_eval',
                        action='store_true',
                        help='If true, inf day eval is performed.')
    parser.add_argument('--official_hyper_params',
                        action='store_true',
                        default=False,
                        help='If true, use official hyper parameters.')
