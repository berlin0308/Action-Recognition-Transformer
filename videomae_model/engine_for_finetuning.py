...
from videomae_model.utils import  MetricLogger, SmoothedValue
...
def train_one_epoch(model: torch.nn.Module,
    ...
    for data_iter_step, (samples, targets) in enumerate( # for data_iter_step, (samples, targets, _, _) in enumerate(
