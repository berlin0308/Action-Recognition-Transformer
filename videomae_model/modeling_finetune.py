...
@register_model
def vit_base_patch16_224(pretrained=True, pretrain_path='./videomae_model/vit_b_k710_dl_from_giant.pth', **kwargs):
    model = VisionTransformer(
        img_size=224,
        in_chans=3,
        num_classes=7,
    ...
    if pretrained:
        ...
        pretrained_dict = {k: v for k, v in pretrained_dict.items() if k in model_dict and k != 'head.weight' and k != 'head.bias'}
...
@register_model
def vit_giant_patch14_224(pretrained=True, pretrain_path="./videomae_model/vit_g_hybrid_pt_1200e_k710_ft.pth", **kwargs):
    model = VisionTransformer(
        img_size=224,
        in_chans=3,
        num_classes=7,
...
#     model = vit_giant_patch14_224(pretrained=True, pretrain_path="vit_g_hybrid_pt_1200e_k710_ft.pth").to(device)
