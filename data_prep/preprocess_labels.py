...
# labeled data path
DATA_LABELED_ROOT =      '/Volumes/BERLIN_SSD/DATA_ALL/Dataset_P/Data_Labeled'
# new folder for preprocessed data
DATA_PREPROCESSED_ROOT = '/Volumes/BERLIN_SSD/DATA_ALL/Dataset_P/Data_Labeled_Preprocessed_mp4'
...
if __name__ == '__main__':
    ...
    #     executor.submit(preprocess_label_mp4)
