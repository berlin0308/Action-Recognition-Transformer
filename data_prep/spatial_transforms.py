...
class Scale(transforms.Resize): # torchvision update, original: Scale
...
class ColorJitter(transforms.ColorJitter):
    ...
    def randomize_parameters(self):
        self.brightness_factor = randomize_value(self.brightness)
        self.contrast_factor = randomize_value(self.contrast)
        self.saturation_factor = randomize_value(self.saturation)
        self.hue_factor = randomize_value(self.hue)
