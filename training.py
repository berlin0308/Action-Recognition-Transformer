...
def train_epoch(epoch,
    ...
    for i, (inputss, targets) in enumerate(data_loader):
        ...
        # inputs, hour = inputss  # visual data, time featuring
        hour = inputss
        inputs = inputss
        # print(hour.size())
        ...
        if time_feature:
            outputs = model(inputs, hour)  # time feature
        else:
            # print(inputs.shape)
        ...
        loss = criterion(outputs, targets)  # cross entropy
